...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SYSTEM"."CHEQUERA_ID_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 NOCACHE  ORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence CLIENTE_CODIGO_CLIENTE_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."CLIENTE_CODIGO_CLIENTE_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 11 NOCACHE  ORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence CUENTA_NUMERO_CUENTA_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."CUENTA_NUMERO_CUENTA_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 19 NOCACHE  ORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SYSTEM"."TRANSACCION_CORRELATIVO_TRANSA"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 59 NOCACHE  ORDER  NOCYCLE ;
--------------------------------------------------------
...
-- No se ha podido presentar el DDL TABLE para el objeto SYSTEM.REPCAT$_INSTANTIATION_DDL mientras que DBMS_METADATA intenta utilizar el generador interno.
...
COMMENT ON COLUMN REPCAT$_INSTANTIATION_DDL.PHASE IS 'Phase to execute the DDL string.';COMMENT ON TABLE REPCAT$_INSTANTIATION_DDL IS 'Table containing supplementary DDL to be executed during instantiation.'ALTER TABLE REPCAT$_INSTANTIATION_DDL
ADD CONSTRAINT REPCAT$_INSTANTIATION_DDL_FK1 FOREIGN KEY
(
  REFRESH_TEMPLATE_ID 
)
...
ON DELETE CASCADE ENABLECREATE UNIQUE INDEX REPCAT$_INSTANTIATION_DDL_PK ON REPCAT$_INSTANTIATION_DDL (REFRESH_TEMPLATE_ID ASC, PHASE ASC, DDL_NUM ASC) 
LOGGING 
TABLESPACE SYSTEM 
PCTFREE 10 
INITRANS 2 
...
NOPARALLELALTER TABLE REPCAT$_INSTANTIATION_DDL
ADD CONSTRAINT REPCAT$_INSTANTIATION_DDL_PK PRIMARY KEY 
(
  REFRESH_TEMPLATE_ID 
, PHASE 
, DDL_NUM 
)
USING INDEX SYSTEM.REPCAT$_INSTANTIATION_DDL_PK
ENABLECREATE TABLE REPCAT$_INSTANTIATION_DDL 
(
...
NOPARALLEL 
LOB (DDL_TEXT) STORE AS SYS_LOB0000020212C00002$$ 
( 
...
Insert into SYSTEM.CHEQUE_EXTERNO (CODIGO_CHEQUE,FECHA,MONTO,BANCO,LOTE,ESTADO_CHEQUE,CUENTA) values (52,to_date('17/11/19','DD/MM/RR'),1000,2,null,7,55988989);
...
Insert into SYSTEM.CLIENTE (CODIGO_CLIENTE,NOMBRE,DIRECCION,NIT,TELEFONO,CORREO,TIPO_CLIENTE,DPI) values (10,'PAM','17 CALLE',22698754,55557788,'correo@gmail.com',1,'2236896560101');
...
SET DEFINE OFF;
Insert into SYSTEM.CUENTA (NUMERO_CUENTA,ESTADO,SALDO_DISPONIBLE,ESTADO_CUENTA,EN_RESERVA,TIPO_CUENTA) values (14,'1',390,1,0,1);
...
Insert into SYSTEM.CUENTA (NUMERO_CUENTA,ESTADO,SALDO_DISPONIBLE,ESTADO_CUENTA,EN_RESERVA,TIPO_CUENTA) values (16,'1',191,1,1000,1);
...
Insert into SYSTEM.EMPLEADO (CODIGO_EMPLEADO,NOMBRE,DIRECCION,TELEFONO,CORREO,ROL,AGENCIA,DPI,CONTRASENA) values (2,'usuario','Guatemala',22538769,'usuario@gmail.com',2,5,'2301576368082','pam');
...
set define off;
  ...
  CREATE OR REPLACE PROCEDURE "SYSTEM"."SOLICITAR_CHEQUERA" (cantidad in INTEGER,numero_cuenta in INTEGER) IS
BEGIN 
