...
namespace WindowsFormsApp1
{
    public partial class NotaCredito : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                connection.Open();
                OracleCommand comando = new OracleCommand("notacredito", connection);
                OracleTransaction transaction;
                ...
                try
                {
                    ...
                    comando.ExecuteNonQuery();
                    transaction.Commit();
                    MessageBox.Show("Se creo nota de credito correctamente");
                    NumeroCuenta.Text = "";
                    Monto.Text = "";
        ...
        private void NotaCredito_Load_1(object sender, EventArgs e)
        {
