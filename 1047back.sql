...
/
--------------------------------------------------------
--  DDL for Procedure BANCO_UPDATE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."BANCO_UPDATE" (pid_banco in INT ,pnombre in VARCHAR2) IS
BEGIN 
...
/
--------------------------------------------------------
--  DDL for Procedure CLIENTES_NO_AGENCIA
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."CLIENTES_NO_AGENCIA" (registros out sys_refcursor, agencia_num in INT)
AS
BEGIN
...
/
--------------------------------------------------------
--  DDL for Procedure CONSULTA_SALDOS_POR_CUENTA
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."CONSULTA_SALDOS_POR_CUENTA" (registros out sys_refcursor, cuenta_id in INT)
AS
BEGIN
    OPEN registros FOR select saldo_disponible as "DISPONIBLE", en_reserva as "RESERVA", (saldo_disponible + en_reserva) as "REAL" from cuenta where numero_cuenta = cuenta_id;
END;

/
--------------------------------------------------------
--  DDL for Procedure CUENTA_SELECT_DANI
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."CUENTA_SELECT_DANI" (registros out sys_refcursor)
AS
BEGIN
...
/
--------------------------------------------------------
--  DDL for Procedure DEPOSITO
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."DEPOSITO" 
(fech in date,valor in float,empleado in integer, agencia in integer,cuen in integer,equipo in integer) IS
BEGIN 
update cuenta set saldo_disponible =(select saldo_disponible from cuenta where NUMERO_CUENTA=cuen)+valor  where NUMERO_CUENTA=cuen;
insert into transaccion (fecha,saldo_inicial,saldo_final,valor,empleado,agencia,cuenta,tipo_transaccion,equipo) values (fech,0,0,valor,empleado,agencia,cuen,1,equipo);
END deposito;


/
--------------------------------------------------------
--  DDL for Procedure DEPOSITOEXTERNO
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."DEPOSITOEXTERNO" 
(fech in date,valor in float,empleado in integer, agencia in integer,cuen in integer,equipo in integer) IS
BEGIN 
update cuenta set en_reserva =(select en_reserva from cuenta where NUMERO_CUENTA=cuen)+valor  where NUMERO_CUENTA=cuen;
insert into transaccion (fecha,saldo_inicial,saldo_final,valor,empleado,agencia,cuenta,tipo_transaccion,equipo) values (fech,0,0,valor,empleado,agencia,cuen,1,equipo);
END depositoExterno;

/
--------------------------------------------------------
--  DDL for Procedure EMPLEADO_ACTUALIZAR
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."EMPLEADO_ACTUALIZAR" 
...
/
--------------------------------------------------------
--  DDL for Procedure EMPLEADO_CREAR
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."EMPLEADO_CREAR" 
(cod in integer,namee varchar2,dir in varchar2,tel in integer, email in varchar2,ro in integer,agen in integer,dp in varchar2,pass in varchar2) IS
BEGIN 
...
/
--------------------------------------------------------
--  DDL for Procedure EMPLEADO_DELETE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."EMPLEADO_DELETE" (id in INT) IS
BEGIN 
...
/
--------------------------------------------------------
--  DDL for Procedure EMPLEADO_SELECT
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."EMPLEADO_SELECT" (registros out sys_refcursor)
as
begin 
...
/
--------------------------------------------------------
--  DDL for Procedure EMPLEADO_UPDATE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."EMPLEADO_UPDATE" (pce in INT, id_rol in INT) IS
BEGIN 
...
/
--------------------------------------------------------
--  DDL for Procedure EQUIPO_DELETE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."EQUIPO_DELETE" (psku in INT) IS
BEGIN 
DELETE FROM equipo 
WHERE sku = psku;
END equipo_delete;
...
/
--------------------------------------------------------
--  DDL for Procedure EQUIPO_INSERT
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."EQUIPO_INSERT" (descripcion in VARCHAR2 DEFAULT 'Nuevo equipo', id_agencia in INT) IS
BEGIN 
...
/
--------------------------------------------------------
--  DDL for Procedure EQUIPO_SELECT
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."EQUIPO_SELECT" (registros out sys_refcursor)
AS
BEGIN
...
/
--------------------------------------------------------
--  DDL for Procedure EQUIPO_UPDATE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."EQUIPO_UPDATE" (psku in INT , pdescripcion in VARCHAR2, id_agencia in INT) IS
BEGIN 
...
/
--------------------------------------------------------
--  DDL for Procedure ESTADOCHEQUE_SELECT
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."ESTADOCHEQUE_SELECT" (registros out sys_refcursor)
as
begin 
...
/
--------------------------------------------------------
--  DDL for Procedure FUNCIONALIDAD_DELETE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."FUNCIONALIDAD_DELETE" (pid_rol in INT) IS
BEGIN 
...
/
--------------------------------------------------------
--  DDL for Procedure FUNCIONALIDAD_INSERT
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."FUNCIONALIDAD_INSERT" (nombre in VARCHAR2 ,descripcion in VARCHAR2 DEFAULT 'Nueva funcionalidad') IS
BEGIN 
...
/
--------------------------------------------------------
--  DDL for Procedure FUNCIONALIDAD_SELECT
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."FUNCIONALIDAD_SELECT" (registros out sys_refcursor)
AS
BEGIN
...
/
--------------------------------------------------------
--  DDL for Procedure GET_ROL_EMPLEADO
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."GET_ROL_EMPLEADO" (codigo_empleado in INT, registros out sys_refcursor) IS
BEGIN 
...
/
--------------------------------------------------------
--  DDL for Procedure MAS_DEPOSITOS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."MAS_DEPOSITOS" (registros out sys_refcursor)
AS
BEGIN
    OPEN registros FOR select cl.nombre as "Nombre", count(t.valor) as "Depositos", t.cuenta as "No. Cuenta", a.direccion as "Agencia" from transaccion t, agencia a, cuenta cu, cliente_cuenta cc, cliente cl
where t.agencia = a.id_agencia and t.cuenta is not null and t.cuenta = cu.numero_cuenta and cc.cuenta = cu.numero_cuenta and cc.cliente = cl.codigo_cliente
group by t.cuenta, a.direccion, cl.nombre
order by count(t.valor) desc;
END;

/
--------------------------------------------------------
--  DDL for Procedure MONTO_MAXIMO
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."MONTO_MAXIMO" (registros out sys_refcursor)
AS
BEGIN
    OPEN registros FOR select cl.nombre as "Nombre", sum(t.valor) as "Monto", t.cuenta as "No. Cuenta", a.direccion as "Agencia" from transaccion t, agencia a, cuenta cu, cliente_cuenta cc, cliente cl
where t.agencia = a.id_agencia and t.cuenta is not null and t.cuenta = cu.numero_cuenta and cc.cuenta = cu.numero_cuenta and cc.cliente = cl.codigo_cliente and (t.cheque_externo is not null or t.cheque_local is not null)
group by t.cuenta, a.direccion, cl.nombre
order by count(t.valor) desc;
...
/
--------------------------------------------------------
--  DDL for Procedure NOTACREDITO
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."NOTACREDITO" 
(fech in date,valor in float,empleado in integer, agencia in integer,cuen in integer,equipo in integer) IS
BEGIN 
update cuenta set saldo_disponible =(select saldo_disponible from cuenta where NUMERO_CUENTA=cuen)+valor  where NUMERO_CUENTA=cuen;
insert into transaccion (fecha,saldo_inicial,saldo_final,valor,empleado,agencia,cuenta,tipo_transaccion,equipo) values (fech,0,0,valor,empleado,agencia,cuen,1,equipo);
...
/
--------------------------------------------------------
--  DDL for Procedure NOTADEBITO
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."NOTADEBITO" 
(fech in date,valor in float,empleado in integer, agencia in integer,cuen in integer,equipo in integer) IS
BEGIN 
update cuenta set saldo_disponible =(select saldo_disponible from cuenta where NUMERO_CUENTA=cuen)-valor  where NUMERO_CUENTA=cuen;
insert into transaccion (fecha,saldo_inicial,saldo_final,valor,empleado,agencia,cuenta,tipo_transaccion,equipo) values (fech,0,0,valor,empleado,agencia,cuen,0,equipo);
END notadebito;
...
/
--------------------------------------------------------
--  DDL for Procedure PERMISO_INSERT
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."PERMISO_INSERT" (rol in INT, funcionalidad in INT) IS
BEGIN 
...
/
--------------------------------------------------------
--  DDL for Procedure REPORTE_CHEQUE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."REPORTE_CHEQUE" (estado in INTEGER,cod in INTEGER) IS
BEGIN 
...
set define off;
  ...
  CREATE OR REPLACE PROCEDURE "SYSTEM"."ROL_DELETE" (pid_rol in INT) IS
BEGIN 
DELETE FROM rol 
...
/
--------------------------------------------------------
--  DDL for Procedure ROL_INSERT
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."ROL_INSERT" (nombre in VARCHAR2 ,descripcion in VARCHAR2 DEFAULT 'Nuevo rol') IS
BEGIN 
...
set define off;
  ...
  CREATE OR REPLACE PROCEDURE "SYSTEM"."ROL_SELECT" (registros out sys_refcursor)
AS
BEGIN
...
/
--------------------------------------------------------
--  DDL for Procedure SALDOS_POR_AGENCIA
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."SALDOS_POR_AGENCIA" (registros out sys_refcursor, id_agencia_ in INT)
AS
BEGIN
    OPEN registros FOR select sum(t.saldo_inicial) AS "Saldo Inicial", sum(t.saldo_final) AS "Saldo Final", (sum(t.saldo_inicial)+ sum(t.saldo_final)) AS "Saldo Real", sum(valor) as "VALOR" 
                       from transaccion t where t.agencia = id_agencia_;
END;

/
--------------------------------------------------------
--  DDL for Procedure SALDOS_POR_AGENCIA_UNICO_DATO
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."SALDOS_POR_AGENCIA_UNICO_DATO" (registros out sys_refcursor)
AS
BEGIN
    OPEN registros FOR select sum(t.valor) AS "Saldo", a.direccion from transaccion t, agencia a
where t.agencia = a.id_agencia group by t.agencia, a.direccion;
END;

/
--------------------------------------------------------
--  DDL for Procedure SENDA_AUDITORIA
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."SENDA_AUDITORIA" (registros out sys_refcursor, cuenta_id in INT)
AS
BEGIN
...
/
--------------------------------------------------------
--  DDL for Procedure SOLICITAR_CHEQUERA
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."SOLICITAR_CHEQUERA" (cantidad in INTEGER,numero_cuenta in INTEGER,correlativo in INTEGER) IS
BEGIN 
INSERT INTO CHEQUERA (cantidad_cheques,CUENTA,ESTADO_CHEQUERA,numero_inicio,numero_final)values (cantidad,numero_cuenta,1,correlativo,correlativo+cantidad-1);
...
/
--------------------------------------------------------
--  DDL for Function DISPONIBLE
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "SYSTEM"."DISPONIBLE" 
( cuen  in INT) 
RETURN float 
as 
resultado float;
	BEGIN
		  select saldo_disponible into resultado from cuenta where  numero_cuenta=cuen ;
...
/
--------------------------------------------------------
--  DDL for Function ESTADOCUENTA
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "SYSTEM"."ESTADOCUENTA" 
( cuenta  in INT) 
RETURN VARCHAR2 is resultado VARCHAR2(100);
	BEGIN
		  select e.nombre into resultado from estado_cuenta e,cuenta c where c.tipo_cuenta=e.codigo_estado and c.numero_cuenta=cuenta;
          return resultado;
    END estadocuenta;

/
--------------------------------------------------------
--  DDL for Function GETCORRELATIVO
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "SYSTEM"."GETCORRELATIVO" 
RETURN INTEGER is resultado integer;
	BEGIN
	SELECT nvl( max(numero_final), 0) into resultado FROM ( SELECT * FROM chequera ORDER BY numero_final desc) WHERE rownum <= 1;
          return resultado+1;
    END getcorrelativo;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "SYSTEM"."LOGIN" 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "SYSTEM"."RESERVA" 
( cuen  in INT) 
RETURN float 
as 
resultado float;
	BEGIN
		  select en_reserva into resultado from cuenta where  numero_cuenta=cuen ;
...
/
--------------------------------------------------------
--  DDL for Function VALIDAD_CUENTA_CHEQUE
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "SYSTEM"."VALIDAD_CUENTA_CHEQUE" 
...
/
--------------------------------------------------------
--  DDL for Function VALIDAR_CHEQUE
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "SYSTEM"."VALIDAR_CHEQUE" 
( cod  in INT) 
RETURN INTEGER is resultado integer;
	BEGIN
...
/
--------------------------------------------------------
--  DDL for Function VALIDAR_CUENTA
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "SYSTEM"."VALIDAR_CUENTA" 
( cuent  in INT) 
RETURN INTEGER is resultado integer;
	BEGIN
...
/
--------------------------------------------------------
--  DDL for Function VALIDAR_EMPLEADO
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "SYSTEM"."VALIDAR_EMPLEADO" 
( cod  in INT) 
RETURN INTEGER is resultado integer;
	BEGIN
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."LOTE" MODIFY ("BANCO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."LOTE" MODIFY ("TIPO_LOTE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."LOTE" MODIFY ("TOTAL" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."LOTE" MODIFY ("CANTIDAD" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."LOTE" MODIFY ("FECHA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."LOTE" MODIFY ("ID_LOTE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."LOTE" ADD CONSTRAINT "LOTE_PK" PRIMARY KEY ("ID_LOTE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."MVIEW$_ADV_PARTITION" MODIFY ("RANK#" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MVIEW$_ADV_PARTITION" MODIFY ("RUNID#" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PERMISO" MODIFY ("FUNCIONALIDAD" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PERMISO" MODIFY ("ROL" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PERMISO" ADD CONSTRAINT "PERMISO_PK" PRIMARY KEY ("ROL", "FUNCIONALIDAD")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."MVIEW$_ADV_INDEX" MODIFY ("MVINDEX#" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MVIEW$_ADV_INDEX" MODIFY ("RANK#" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MVIEW$_ADV_INDEX" MODIFY ("RUNID#" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."LOTE" ADD CONSTRAINT "LOTE_BANCO_FK" FOREIGN KEY ("BANCO")
	  REFERENCES "SYSTEM"."BANCO" ("ID_BANCO") ENABLE;
  ALTER TABLE "SYSTEM"."LOTE" ADD CONSTRAINT "LOTE_TIPO_LOTE_FK" FOREIGN KEY ("TIPO_LOTE")
	  REFERENCES "SYSTEM"."ESTADO_LOTE" ("ID_TIPO") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PERMISO" ADD CONSTRAINT "PERMISO_FUNCIONALIDAD_FK" FOREIGN KEY ("FUNCIONALIDAD")
	  REFERENCES "SYSTEM"."FUNCIONALIDAD" ("CODIGO_FUNCIONALIDAD") ENABLE;
  ALTER TABLE "SYSTEM"."PERMISO" ADD CONSTRAINT "PERMISO_ROL_FK" FOREIGN KEY ("ROL")
	  REFERENCES "SYSTEM"."ROL" ("ID_ROL") ENABLE;
--------------------------------------------------------
